...
zdt   = [ %---- Voltage Magnitude ------------%
           ...
           %------------------------------------%
           %------ Real Power Flow ------------- %
%            12     4    0.3150   1       2   50e-6;
%            13     4    0.3890   1       4   50e-6;
%            14     4    0.3570   1       5   50e-6;
%            15     4   -0.3490   2       1   50e-6;
%            16     4    0.3280   2       4   50e-6;
%            17     4    0.1740   2       5   50e-6;
%            18     4    0.2230   2       6   50e-6;
%            19     4    0.0860   2       3   50e-6;
%            20     4   -0.0210   3       2   50e-6;
%            21     4    0.1770   3       5   50e-6;
%            22     4    0.4330   3       6   50e-6;
%            23     4   -0.4010   4       1   50e-6;
%            24     4   -0.2980   4       2   50e-6;
%            25     4    0.0070   4       5   50e-6;
%            26     4   -0.0210   5       4   50e-6;
%            27     4   -0.3660   5       1   50e-6;
%            28     4   -0.1170   5       2   50e-6;
%            29     4   -0.2510   5       3   50e-6;
%            30     4   -0.0210   5       6   50e-6;
%            31     4    0.0100   6       5   50e-6;
%            32     4   -0.1960   6       2   50e-6;
%            33     4   -0.4680   6       3   50e-6;
%            %------------------------------------%
%            %------ Reactive Power Flow ------------- %
%            34     5   -0.1320   1       2   50e-6;
%            35     5    0.2120   1       4   50e-6;
%            36     5    0.0940   1       5   50e-6;
%            37     5    0.0970   2       1   50e-6;
%            38     5    0.3830   2       4   50e-6;
%            39     5    0.2200   2       5   50e-6;
%            40     5    0.1500   2       6   50e-6;
%            41     5   -0.1190   2       3   50e-6;
%            42     5    0.1020   3       2   50e-6;
%            43     5    0.2390   3       5   50e-6;
%            44     5    0.5830   3       6   50e-6;
%            45     5   -0.1430   4       1   50e-6;
%            46     5   -0.4430   4       2   50e-6;
%            47     5   -0.1740   4       5   50e-6;
%            48     5   -0.0150   5       4   50e-6;
%            49     5   -0.1750   5       1   50e-6;
%            50     5   -0.2220   5       2   50e-6;
%            51     5   -0.2990   5       3   50e-6;
%            52     5   -0.0080   5       6   50e-6;
%            53     5    0.0290   6       5   50e-6;
%            54     5   -0.2230   6       2   50e-6;
%            55     5   -0.5110   6       3   50e-6];
           %--------------------------------------%
% elseif num == 14
% %         |Msnt |Type | Value | From | To | Rii | 
% zdt   = [ %---- Voltage Magnitude ------------%
...
%             8     1    1.06     8       0   9e-4;
%             9     1    1.044    9       0   9e-4;
%             10    1    1.039    10      0   9e-4;
%             11    1    1.046    11      0   9e-4;
%             12    1    1.045    12      0   9e-4;
%             13    1    1.040    13      0   9e-4;
%             14    1    1.024    14      0   9e-4;
%             %-----------------------------------%
%             %---- Real Power Injection ---------%
%             2     2    0.1830   2       0   1e-4;
%             3     2   -0.9420   3       0   1e-4; 
